<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background: linear-gradient(135deg, #4e73df, #1d3c6d);">
    ...
    <!-- Clients and Leads -->
    <li class="nav-item">
        <a class="nav-link" href="clients.php" style="font-family: 'Poppins', sans-serif;">
            <i class="fas fa-fw fa-user-friends"></i>
            <span>Clients</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="leads.php" style="font-family: 'Poppins', sans-serif;">
    ...
    <li class="nav-item">
        <a class="nav-link" href="assets.php" style="font-family: 'Poppins', sans-serif;">
    ...
    <li class="nav-item">
        ...
        <div id="collapseSettings" class="collapse" aria-labelledby="headingSettings" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="roles-permissions.php">Roles & Permissions</a>
