...
if (isset($_GET['deleteEmployeeId'])) {
    $employeeId = intval($_GET['deleteEmployeeId']);
    $deleteQuery = "DELETE FROM view_employee WHERE id = ?";
    $deleteStmt = $con->prepare($deleteQuery);
    $deleteStmt->bind_param("i", $employeeId);
    $deleteStmt->execute();
    echo "<script>alert('Employee deleted successfully.'); window.location.href='view_employees.php?trainingId={$trainingId}';</script>";
}
?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editEmployeeModal" 
                                                    ...
                                                    data-name="<?php echo htmlentities($employee['employee_name']); ?>">
                                                Edit
                                            </button>

                                            <!-- Delete Button -->
                                            <a href="view_employees.php?trainingId=<?php echo $trainingId; ?>&deleteEmployeeId=<?php echo $employee['id']; ?>" 
